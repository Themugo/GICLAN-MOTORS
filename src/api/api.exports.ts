...
export const paymentsAPI = {
  ...
  myPayments:  (params?: any) => api.get('/payments/my', { params }).then(unwrap),
...
export const dealerAPI = {
  ...
  getSubscription: () => api.get('/subscriptions/my-subscription').then(unwrap),
  getSubscriptionPlans: () => api.get('/subscriptions/plans').then(unwrap),
  getUsageLimits: () => api.get('/subscriptions/usage-limits').then(unwrap),
  cancelSubscription: () => api.post('/subscriptions/cancel').then(unwrap),
  reactivateSubscription: () => api.post('/subscriptions/reactivate').then(unwrap),
