...
const checks = [
  ...
  ["canonical chat surface has no simulated dealer response", !fs.readFileSync(path.join(root,"src/features/UnifiedCommunicationHub.tsx"),"utf8").includes('Simulate dealer response')],
